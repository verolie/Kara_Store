    ...
    <body id="page-top">
        <nav class="navbar navbar-expand-lg navbar-light  py-3" id="mainNav">
            <div class="container px-4 px-lg-5">
                <img src="asset/img/Logo_White.png" width="105px" height="70px" class="navbar-brand">
                <button class="navbar-toggler navbar-toggler-right" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link" href="http://localhost:8080/kara_project/kart_con">Kart</a></li>
                        <li class="nav-item"><a class="nav-link" href="#portfolio">Order</a></li>
                        <li class="nav-item"><a class="nav-link" href="http://localhost:8080/kara_project/login"><?php echo $user;?></a></li>
                    </ul>
                </div>
            </div>
        </nav>
